...
Si vous choisissez d'activer la sauvegarde iCloud dans l'application, vos données sont synchronisées via votre compte personnel Apple iCloud. Ces données :

- Sont chiffrées et gérées par Apple conformément à leur [politique de confidentialité](https://www.apple.com/fr/privacy/)
- Ne sont accessibles que via votre Apple ID
- Ne nous sont accessibles en aucune manière

Vous pouvez désactiver la sauvegarde iCloud à tout moment dans les réglages de l'application.
...
Lunette ne collecte pas sciemment d'informations auprès d'enfants. L'application ne contient aucun contenu inapproprié et est classée 4+.
